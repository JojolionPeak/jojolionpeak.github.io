(function () {
  ...
  function showPasswordModal() {
    ...
    box.setAttribute('aria-labelledby', 'modal-pw-title');

    const heading = document.createElement('h2');
    heading.id = 'modal-pw-title';
  ...
  function showAddModal() {
    ...
    box.setAttribute('role', 'dialog');
    box.setAttribute('aria-modal', 'true');
    box.setAttribute('aria-labelledby', 'modal-add-title');

    const heading = document.createElement('h2');
    heading.id = 'modal-add-title';
